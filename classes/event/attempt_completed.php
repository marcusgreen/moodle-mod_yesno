...
/**
 * The mod_yesno attempt completed event.
 *
 * @package    mod_yesno
...
/**
 * The mod_yesno attempt completed event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int yesnoid: id of the yesno activity.
 *      - string status: 'win' or 'loss'.
...
class attempt_completed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' completed attempt with id '$this->objectid' " .
            ...
            "with status '" . $this->other['status'] . "' and score " . $this->other['score'] . ".";
    }
    ...
    public static function get_name() {
        return get_string('eventattemptcompleted', 'mod_yesno');
    }
    ...
    public static function get_other_mapping() {
        return [
            ...
            'score' => \core\event\base::NOT_MAPPED,
        ];
    }
}
