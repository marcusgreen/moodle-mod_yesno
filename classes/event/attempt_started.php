...
/**
 * The mod_yesno attempt started event.
 *
 * @package    mod_yesno
...
/**
 * The mod_yesno attempt started event class.
 *
...
class attempt_started extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptstarted', 'mod_yesno');
    }
    ...
    public static function get_other_mapping() {
        return ['yesnoid' => ['db' => 'yesno', 'restore' => 'yesno']];
    }
}
